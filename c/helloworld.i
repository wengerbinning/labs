...
struct register {
 int default;
 struct regmap map[32];
};
# 34 "helloworld.c"
struct register register_demo = { .default = 0x0000 };

static inline int set_map(struct register *reg, int n, int m, const char *name) {
...
void reg_dump(struct register *reg) {
 int i;
 struct regmap *map;
...
int main (int argc, char *argv[]) {
 printf("Hello, World! %d #%08X %s\n", 8, ((8) <= (10) ? ((1ULL | ((((1ULL << 10) - 1)) << 1)) - (((1ULL << 8) - 1))) : 0), "dmeo");
 reg_dump(&register_demo);
 return 0;
}
